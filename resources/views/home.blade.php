...
<main>
    ...
    <!-- ===== Depoimentos ===== -->
    @include ('layouts.depoimentos')
    
    


    <!-- ===== Blog Start ===== -->
    @include ('layouts.artigos-recentes')
                    ...
                    <form action="https://formbold.com/s/unique_form_id" method="POST">
                        <div class="tc sf yo ap zf ep qb">
                            <div class="vd to/2">
                                ...
                                <input type="text" name="fullname" id="fullname" placeholder="Digite se nome completo" class="vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi" />
                            </div>

                            <div class="vd to/2">
                                <label class="rc ac" for="email">Endereço de Email</label>
                                <input type="email" name="email" id="email" placeholder="Seu melhor e-mail" class="vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi" />
                            </div>
                        </div>

                        <div class="tc sf yo ap zf ep qb">
                            <div class="vd to/2">
                                <label class="rc ac" for="phone">Telefone de Contato</label>
                                <input type="text" name="phone" id="phone" placeholder="Telefone com DDD" class="vd ph sg zk xm _g ch pm hm dm dn em pl/50 xi mi" />
                            </div>
                        ...
                        <div class="fb">
                            ...
                            <textarea placeholder="Descreva brevemente sobre o assunto citado acima." rows="4" name="message" id="message" class="vd ph sg zk xm _g ch pm hm dm dn em pl/50 ci"></textarea>
                        </div>

                        <div class="tc xf">
                            <button class="vc rg lk gh ml il hi gi _l">Enviar Mensagem</button>
                        </div>
                    </form>
                </div>
            </div>
