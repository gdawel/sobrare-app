                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="c tc wf xf wd in zc hn rg uj fo wk xm ml il hh rm tl zm yl an">>{{ $page }}<</span>
                                    </span>
                                @else
