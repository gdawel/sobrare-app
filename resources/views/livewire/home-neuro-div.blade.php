  ...
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
    ...
    <div class="mt-5 max-w-xl text-center mx-auto">
      <h1 class="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
        Neurodiversidade e Produtividade
      </h1>
    </div>
    <!-- End Title -->
...
<div class=" bg-white max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
    ...
    <div class="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-neutral-800">
      ...
      <h4 wire:key="{{ $grupo->slug }}" class="font-medium text-lg text-gray-800 dark:text-neutral-200">{{ $grupo->nomeGrupo }}</h4>
      <span class="mt-5 font-bold text-5xl text-gray-800 dark:text-neutral-200">
        <span class="font-bold text-2xl -me-2">R$</span>
        {{ $grupo->precoGrupo }}
      </span>
      <p class="mt-2 text-sm text-gray-500 dark:text-neutral-500">{{ $grupo->memoInterno }}</p>
