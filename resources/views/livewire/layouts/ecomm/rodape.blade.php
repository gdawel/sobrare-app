<div>
  ...
  <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-10 mx-auto">
    <!-- Grid -->
    ...
    <div class="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
      <div class="flex justify-between items-center">
        <p class="text-lg text-gray-400">© SOBRARE. Todos os direitos reservados. CNPJ: 10.786.446/0001-47 | CRP-J/SP 3825/J</p>
      </div>
      <!-- End Col -->
