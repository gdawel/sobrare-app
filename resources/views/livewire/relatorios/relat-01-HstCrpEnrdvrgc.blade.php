    ...
    <div class="flex flex-col p-4 sm:p-10 bg-white shadow-md rounded-xl dark:bg-neutral-800">
      ...
      <div class="mt-8 grid sm:grid-cols-2 gap-3">
        <div>
          ...
          <address class="text-sm mt-2 not-italic text-gray-500 dark:text-neutral-500">
        ...
        <div class="sm:text-end space-y-2">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
            <dl class="grid sm:grid-cols-5 gap-x-3">
              ...
              <dd class="text-sm col-span-2 text-gray-500 dark:text-neutral-500">{{ $dadosRelatorio['dataEmissao'] }}</dd>
            </dl>
            <dl class="grid sm:grid-cols-5 gap-x-3">
              <dt class="text-sm col-span-3 font-semibold text-gray-800 dark:text-neutral-200">Respondido em:</dt>
              <dd class="text-sm col-span-2 text-gray-500 dark:text-neutral-500">{{ $dadosRelatorio['dataFinalTeste'] }}</dd>
            </dl>
          </div>
          <!-- End Grid -->
        </div>
      ...
      <div class="pt-8 hidden sm:block border-b border-gray-200 dark:border-neutral-700"></div>
        {{-- Subtítulo da Seção --}}
      <div class="text-xl text-center font-semibold text-gray-400">Perfil Sociodemográfico</div> 
    ...
    {{-- <a class="group flex gap-y-6 size-full hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg p-5 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="#"> --}}
      ...
      <div>
        <div>
          ...
          <p class="text-sm text-gray-600 dark:text-neutral-400">{{ $dadosRelatorio['sexoBiologico'] }}</p>
        </div>
    ...
    {{-- <a class="group flex gap-y-6 size-full hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg p-5 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="#"> --}}
      ...
      <div>
        <div>
          ...
          <p class="text-sm text-gray-600 dark:text-neutral-400">{{ $dadosRelatorio['dadosCliente']['genero'] }}</p>
        </div>
    ...
    {{-- <a class="group flex gap-y-6 size-full hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg p-5 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="#"> --}}
      ...
      <div>
        <div>
          ...
          <p class="text-sm text-gray-600 dark:text-neutral-400">{{ $dadosRelatorio['dadosCliente']['etnia'] }}</p>
        </div>
    ...
    {{-- <a class="group flex gap-y-6 size-full hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg p-5 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="#"> --}}
      ...
      <div>
        <div>
          ...
          <p class="text-sm text-gray-600 dark:text-neutral-400">{{ $dadosRelatorio['dadosCliente']['maoMaisAgil'] }}</p>
        </div>
    ...
    {{-- <a class="group flex gap-y-6 size-full hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg p-5 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="#"> --}}
      ...
      <div>
        <div>
          ...
          <p class="text-sm text-gray-600 dark:text-neutral-400">{{ $dadosRelatorio['estadoNascimentoCliente'] }}</p>
        </div>
    ...
    {{-- <a class="group flex gap-y-6 size-full hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg p-5 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="#"> --}}
      ...
      <div>
        <div>
          ...
          <p class="text-sm text-gray-600 dark:text-neutral-400">{{ $dadosRelatorio['dadosCliente']['cidadeQueReside'] }}</p>
        </div>
    ...
    {{-- <a class="group flex gap-y-6 size-full hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg p-5 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="#"> --}}
      ...
      <div>
        <div>
          ...
          <p class="text-sm text-gray-600 dark:text-neutral-400">{{ $dadosRelatorio['dadosCliente']['outrosIdiomas'] }}</p>
        </div>
    ...
    {{-- <a class="group flex gap-y-6 size-full hover:bg-gray-100 focus:outline-none focus:bg-gray-100 rounded-lg p-5 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="#"> --}}
      ...
      <div>
        <div>
          ...
          <p class="text-sm text-gray-600 dark:text-neutral-400">{{ $dadosRelatorio['dadosCliente']['grauEscolar'] }}</p>
        </div>
...
<div class="pt-8 hidden sm:block border-b border-gray-200 dark:border-neutral-700"></div>
      ...
      <div class="mt-6">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            ...
            <tr class="odd:bg-white border-b odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800  dark:border-gray-700">
                <th scope="row" class="px-6 py-2 font-normal text-gray-900 text-pretty dark:text-white">
        ...
        {{-- <div class="border border-gray-200 p-6 rounded-lg space-y-6 dark:border-neutral-700"> --}}
          ...
          <div class="mt-4">
            ...
            <div class="mt-2 px-5 italic text-xs text-left font-normal text-gray-500">
      ...
      <p class="mt-4 text-sm text-gray-500 dark:text-neutral-500">© 2024 SOBRARE - Todos os direitos reservados.</p>
