  ...
  <div class="py-4 px-6 flex justify-between text-sm font-medium text-gray-800 dark:text-gray-400">
      ...
      <div class="text-right">
          ...
          {{-- ///  RELATÓRIO CARACTERÍSTICAS LIGADAS À DISLEXIA, ATENÇÃO E A CONCENTRAÇÃO  Adultos --}}
            ...
            <p class="border border-gray-300 py-1 px-2 text-center text-xs dark:text-gray-400 align-top">É Raro: {{ $contarRaro }}</p>
            <p class="border border-gray-300 py-1 px-2 text-center text-xs dark:text-gray-400 align-top">Algumas Vezes: {{ $contarAlgumasVezes }}</p>
            <p class="border border-gray-300 py-1 px-2 text-center text-xs dark:text-gray-400 align-top">Bastante: {{ $contarAconteceBastante }}</p>
            <p class="border border-gray-300 py-1 px-2 text-center text-xs dark:text-gray-400 align-top">Frequente: {{ $contarFrequente }}</p>
            <p colspan="3" class="border border-gray-300 py-2 px-4 text-sm dark:text-gray-400">{!! $textoDiagnostico !!}</p>
          <!-- End Table -->
