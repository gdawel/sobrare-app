  ...
  <div class="w-full lg:w-3/4 mx-auto">
    ...
    <div class="flex flex-col p-0 sm:p-10 bg-white shadow-md rounded-xl dark:bg-neutral-800">
      ...
      <div class="hidden sm:block border-b border-gray-200 dark:border-neutral-700"></div>
          <div class="">
            <h2 class="text-xl font-semibold text-blue-600 mb-2">Inventário para Distúrbios Depressivos</h2>
            ...
            <div class="col-span-12 text-orange-500">
              ...
              <p class="text-sm font-medium text-gray-800 uppercase dark:text-neutral-500">{{ $subHeading }} </p>
                ...
                @else 
                      ...
                      <p class="text-sm p-1 font-semibold dark:text-neutral-200 text-gray-800">
                  ...
                  @if(isset($item->comentariosCliente))
                      ...
                      <p class="text-sm p-1 dark:text-neutral-200 text-gray-800">Comentário: {{ $item->comentariosCliente }}</p>
                  @endif
