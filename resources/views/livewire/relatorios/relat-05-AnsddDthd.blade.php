  ...
  <div class="w-full lg:w-3/4 mx-auto">
    ...
    <div class="flex flex-col p-0 sm:p-10 bg-white shadow-md rounded-xl dark:bg-neutral-800">
      ...
      <div class="hidden sm:block border-b border-gray-200 dark:border-neutral-700"></div>
          <div class="">
            <h2 class="text-xl font-semibold text-blue-600 mb-2">Sintomatologia da Ansiedade e seus detalhes de frequência e gravidade:</h2>
            ...
            <div class="col-span-12">
              ...
              <p class="text-sm p-1 font-semibold text-gray-800 dark:text-neutral-200">
                ...
                @else 
                  ...
                  {{ $item->textoResposta->textoResposta }}</p>
