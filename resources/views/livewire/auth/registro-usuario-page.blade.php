      ...
      <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div class="p-4 sm:p-7">
          <div class="text-center">
            <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Registre-se</h1>
          ...
          <form wire:submit.prevent="salvar">
            <div class="grid gap-y-4">
              ...
              <div>
                <label for="name" class="block text-sm mb-2 dark:text-white">Nome Completo</label>
                <div class="relative">
                  <input type="text" id="name" wire:model="nome" class="py-3 px-4 block w-full border
              ...
              <div>
                <label for="email" class="block text-sm mb-2 dark:text-white">Endereço de E-mail</label>
                <div class="relative">
              ...
              <div>
                ...
                <div class="relative">
                  <input type="password" id="password" wire:model="senha" class="py-3 border px-4 block w-full
                       border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 
