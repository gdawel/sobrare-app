      ...
      <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <div class="p-4 sm:p-7">
          <div class="text-center">
            <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Redefinir a Senha</h1>
          </div>
          ...
          <div class="mt-5">
            ...
            <form>
              <div class="grid gap-y-4">
                <!-- Form Group -->
                <div>
                  <label for="password" class="block text-sm mb-2 dark:text-white">Nova Senha</label>
                  <div class="relative">
                ...
                <div>
                  <label for="password_confirmation" class="block text-sm mb-2 dark:text-white">Confirme a Nova Senha</label>
                  <div class="relative">
                  ...
                  <p class="text-xs text-red-600 mt-2" id="password_confirmation-error">Confirmação de Senha não Confere</p>
                </div>
