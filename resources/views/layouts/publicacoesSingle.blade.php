            ...
            <div class="tc sf yo zf kq">
                <div class="ro">
                    <div class="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-7.5 md:p-10">
                        ...
                        <p>
                            ...
                            Esta força que impulsiona o ser humano a se adaptar a uma nova realidade é a resiliência. E ela é tão poderosa para a humanidade como um todo, como para o indivíduo. Você deve conhecer! - Dawel, George.
                        </p>
                ...
                <div class="jn/2 so">
                    <div class="animate_top fb">
                        <form action="#">
                            <div class="i">
                                <input type="text" placeholder="Pesquise..(falta fazer)" class="vd sm _g ch pm vk xm rg gm dm/40 dn/40 li mi" />
                    ...
                    <div class="animate_top fb">
                        ...
                        <ul>
                            <!-- <li class="ql vb du-ease-in-out il xl">
                                <a href="{{ url ('/publicacoes') }}">Ver Todas</a>
                            </li> -->
                            @foreach ($categorias as $categoria)
                            <li class="ql vb du-ease-in-out il xl">
                    ...
                    <!-- <div class="animate_top">
                        <h4 class="tj kk wm qb">Artigos Relacionados</h4>
