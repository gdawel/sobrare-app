  ...
  <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
    ...
    >
      <nav>
        <ul class="tc _o sf yo bg ep">
          ...
          <li class="c i" x-data="{ dropdown: false }">
            ...
            <!-- Dropdown Start -->
            <ul class="a" :class="{ 'tc': dropdown }">
              <li><a href="./blogSinglePost.php" class="xl" :class="{ 'ak': page === 'blog-grid' }">E-books</a></li>
              <li><a href="./blogSinglePost.php" class="xl" :class="{ 'ak': page === 'blog-grid' }">Cursos</a></li>
              <li><a href="./blogSinglePost.php" class="xl" :class="{ 'ak': page === 'blog-single' }">Diagnósticos</a></li>
      ...
      <div class="tc wf ig pb no">
        ...
        <a href="signin.php" :class="{ 'nk yl' : page === 'home', 'ok' : page === 'home' && stickyMenu }" class="ek pk xl">Entrar</a>
