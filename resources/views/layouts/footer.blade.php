...
<footer>
    <div class="bb ze ki xn 2xl:ud-px-0">
        ...
        <div class="ji gp">
            <div class="tc uf ap gg fp">
                <div class="animate_top zd/2 to/4">
                    <a href="index.html">
                        <img src="images/sobrare_logo_fundo_transparente2.png" alt="Logo Sobrare" class="om" />
                ...
                <div class="vd ro tc sf rn un gg vn">
                    ...
                    <div class="animate_top">
                        ...
                        <form action="https://formbold.com/s/unique_form_id" method="POST">
                            <div class="i">
                                <input type="text" placeholder="E-mail" class="vd sm _g ch pm vk xm rg gm dm dn gi mi" />
        ...
        <div class="bh ch pm tc uf sf yo wf xf ap cg fp bj">
            <div class="animate_top">
                <ul class="tc wf gg">
                    <li><a href="#" class="xl">Termos de Uso</a></li>
