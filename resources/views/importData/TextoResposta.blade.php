        ...
        <div class="row bg-slate-200 m-12 ">
            ...
            <div class="border-solid border-2 border-indigo-600 p-6">
                ...
                <h1 class="font-sans text-xl text-gray-800 text-center">
                    Importação da Tabela de Textos das Respostas<br>.....<br><br></h1>
                

                <div class=" font-sans text-md text-gray-800 text-center">
                        <form action="{{ url('import/texto-resposta') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="flex-auto">
                                ...
                                <button type="submit" class="float-right bg-blue-500 hover:bg-blue-700 text-white text-sm    
                                        ...
                                        focus:shadow-outline" type="button">Importar Textos Respostas
                                </button>
                            </div>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left rtl:text-right text-blue-100 dark:text-blue-100">
            ...
            <tbody>
                                ...
                                @foreach ($listarTextoRespostas as $textoResposta)
                                <tr class="bg-blue-500 border-b border-blue-400 text-xs">
                                    <td>{{ $textoResposta->id }}</td>
                                    <td>{{ $textoResposta->codTextoResposta }}</td>
                                    <td>{{ $textoResposta->textoResposta }}</td>
