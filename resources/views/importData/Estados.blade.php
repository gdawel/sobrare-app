        ...
        <div class="row bg-slate-200 m-12 ">
            ...
            <div class="border-solid border-2 border-indigo-600 p-6">
                ...
                <h1 class="font-sans text-xl text-gray-800 text-center">
                    Importação da Tabela de Estados<br>.....<br><br></h1>
                

                <div class=" font-sans text-md text-gray-800 text-center">
                        <form action="{{ url('import/estados') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="flex-auto">
                                ...
                                <button type="submit" class="float-right bg-blue-500 hover:bg-blue-700 text-white text-sm    
                                        ...
                                        focus:shadow-outline" type="button">Importar Estados
                                </button>
                            </div>
                            <p class="text-sm text-center italic"><br><br> O arquivo a ser selecionado nesta tela deve ter apenas a Tabela de Estados.</p>
                        </form>
                    <div class="flex-auto">
