        ...
        <div class="row bg-slate-200 m-12 ">
            ...
            <div class="border-solid border-2 border-indigo-600 p-6">
                ...
                <h1 class="font-sans text-xl text-gray-800 text-center">
                    Importação da Tabela de Graus Escolares<br>.....<br><br></h1>
                

                <div class=" font-sans text-md text-gray-800 text-center">
                        <form action="{{ url('import/grau-escolar') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="flex-auto">
                                ...
                                <button type="submit" class="float-right bg-blue-500 hover:bg-blue-700 text-white text-sm    
                                        ...
                                        focus:shadow-outline" type="button">Importar Graus Escolares
                                </button>
                            </div>
                            <p class="text-sm text-center italic"><br><br> O arquivo a ser selecionado nesta tela deve ter apenas a Tabela de Graus Escolares.</p>
                        </form>
                    <div class="flex-auto">
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left rtl:text-right text-blue-100 dark:text-blue-100">
            ...
            <tbody>
                                ...
                                @foreach ($listarGrausEscolares as $grau_escolar)
                                <tr class="bg-blue-500 border-b border-blue-400 text-xs">
                                    <td>{{ $grau_escolar->id }}</td>
                                    <td>{{ $grau_escolar->grau_escolar }}</td>
